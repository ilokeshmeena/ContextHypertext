...
class ResultAdapterInternet(val result: Array<Int>, val time: DoubleArray
//                    ,val eyeTime:DoubleArray
) :
    RecyclerView.Adapter<ResultAdapterInternet.ResultViewHolder>() {
